<?php
        ...
        $GLOBALS['WKPDF_BASE_PATH']='';//'C:/Program Files (x86)/wkhtmltopdf/';//str_replace(str_replace('\\','/',getcwd().'/'),'',dirname(str_replace('\\','/',__FILE__))).'/';
        $GLOBALS['WKPDF_EXE_NAME']='wkhtmltopdf.exe';
        ...
        class WKPDF {
                ...
                public function __construct(){
                        $this->cmd=$GLOBALS['WKPDF_BASE_PATH'].$GLOBALS['WKPDF_EXE_NAME'];
